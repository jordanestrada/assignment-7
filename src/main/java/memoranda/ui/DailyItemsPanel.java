...
import interfaces.INoteListener;
...
public class DailyItemsPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        CurrentProject.addProjectListener(new IProjectListener() {
            public void projectChange(IProject p, INoteList nl, TaskList tl, ResourcesList rl) {
...
//                // DEBUG
        ...
        EventsScheduler.addListener(new IEventNotificationListener() {
            public void eventIsOccured(interfaces.IEvent ev) {
                /*DEBUG*/
...
//		Util.debug("currentNoteChanged");
    ...
    void currentProjectChanged(IProject newprj, INoteList nl, TaskList tl, ResourcesList rl) {
    ...
    public void updateIndicators(CalendarDate date, TaskList tl) {
        ...
        if (date.equals(CalendarDate.today())) {
            ...
            if (EventsScheduler.isEventScheduled()) {
                ...
                interfaces.IEvent ev = EventsScheduler.getFirstScheduledEvent();
