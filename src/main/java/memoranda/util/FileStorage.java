...
public class FileStorage implements Storage {
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeNote(interfaces.INote)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#openNote(interfaces.INote)
     */
...
//        CalendarDate d = note.getDate();
    ...
    /**
     * @see main.java.memoranda.util.Storage#removeProject(interfaces.IProject)
     */
    ...
    public TaskList openTaskList(IProject prj) {
    ...
    public void storeTaskList(TaskList tasklist, IProject prj) {
        /*DEBUG*/
        System.out.println(
    ...
    /**
     * @see main.java.memoranda.util.Storage#createProjectStorage(interfaces.IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#openNoteList(interfaces.IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeNoteList(interfaces.INoteList, interfaces.IProject)
     */
    ...
    /**
     * @see main.java.memoranda.util.Storage#openResourcesList(interfaces.IProject)
     */
    public ResourcesList openResourcesList(IProject prj) {
    ...
    /**
     * @see main.java.memoranda.util.Storage#storeResourcesList(interfaces.ResourcesList, interfaces.IProject)
     */
    public void storeResourcesList(ResourcesList rl, IProject prj) {
        /*DEBUG*/
        System.out.println(
